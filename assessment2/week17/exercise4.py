...
def main():
    ...
    for i in range(len(Eve)):
        if Eve[i] < treshold:
            ...
            EveNoLoginCount += 1
    print(AliceLoginCount)
    print(AliceNoLoginCount)
    print(EveLoginCount)
    print(EveNoLoginCount)
    return 0
